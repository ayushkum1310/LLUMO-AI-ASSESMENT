# -*- coding: utf-8 -*-
#
# LLUMO AI ASSESMENT documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'LLUMO-AI-ASSESMENTdoc'
...
latex_documents = [
    ('index',
     'LLUMO-AI-ASSESMENT.tex',
     u'LLUMO AI ASSESMENT Documentation',
...
man_pages = [
    ('index', 'LLUMO-AI-ASSESMENT', u'LLUMO AI ASSESMENT Documentation',
     [u"Ayush Kumar"], 1)
]
